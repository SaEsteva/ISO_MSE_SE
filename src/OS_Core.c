...
/*************************************************************************************************
     ...
     *
     *  @details
     *   Tarea Idle con prioridad mï¿½nima de ejecuciï¿½n.
     *
	 *  @param 		None.
	 *  @return     None.
***************************************************************************************************/
...
/*************************************************************************************************
	 ...
	 *  @param id_tarea			Nï¿½mero de identificaciï¿½n de la tarea.
...
void SysTick_Handler(void)  {
	...
	/*
	 * En caso de contar con tareas bloqueadas, dado que paso un tick de sistema de deberÃ­a decrementar el contador
	 */
